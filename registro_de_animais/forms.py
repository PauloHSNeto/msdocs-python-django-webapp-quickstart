...
class AddAnimalForm(forms.ModelForm):
    ...
    ani_dnasc = DateField(widget=forms.TextInput(attrs={'class': 'form-control datepicker'}), label='Data de nascimento do animal', required=False)
    ...
    class Meta:
        ...
        widgets = {
            ...
            'ani_dnasc': forms.DateInput(attrs={'type': 'text', 'class': 'form-control datepicker', 'blank': True}),
